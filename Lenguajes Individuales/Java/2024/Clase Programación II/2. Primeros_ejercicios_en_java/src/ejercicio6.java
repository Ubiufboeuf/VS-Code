...
public class ejercicio6 {
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        System.out.print("Ingrese una cantidad de dinero en pesos uruguayos: ");
        int pesos = sc.nextInt();

        int dol = pesos / 40;

        if (dol == 1) {
            System.out.println("La cantidad de dinero ingresada en pesos equivale (aprox.) a: " + dol + " dólar");
        } else {
            System.out.println("La cantidad de dinero ingresada en pesos equivale (aprox.) a: " + dol + " dólares");
        }
    }    
}
